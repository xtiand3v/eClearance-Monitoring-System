...
<div class="main" style="background: url(src/img/bg-logo.jpg);background-repeat: no-repeat;background-size: auto;background-position: top">
    ...
    <main class="content">
        <div class="container-fluid p-0">
            ...
            <h1 class="h3 mb-3"><strong>Sections</strong> </h1>
                                    ...
                                    <div class="col-12 col-lg-12 col-xxl-12 d-flex">
                                        <div class="card flex-fill p-3">
                                            ...
                                            <table class="table table-hover my-0" id="department">
                                                ...
                                                <tbody>
                                                    <?php 
                                                    $dept = $con->query("SELECT * FROM sections d INNER JOIN faculties s ON s.faculty_id = d.faculty_id ORDER BY d.section_name ASC");
                                                    $i = 1;
                                                    while($row = $dept->fetch_assoc()){
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="enroll.php?id=<?php echo $row['section_id']; ?>" class="btn btn-success btn-sm">Enroll Student</a>
