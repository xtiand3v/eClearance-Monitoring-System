    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body m-3">
                <form class="form-horizontal" method="POST" action="account-edit.php">
                    <input type="hidden" class="acc_id" name="id">
                    <div class="form-group">
                        <label for="edit_name" class="col-sm-3 control-label">Username</label>
                    ...
                    <div class="form-group">
                        <label for="edit_name" class="col-sm-3 control-label">Password</label>
                    ...
                    <div class="form-group">
                        <label for="edit_name" class="col-sm-3 control-label">Account Type</label>

                        <div class="col-sm-12">
                            <select class="form-control" id="edit_type" name="account" required>
...
<div class="modal fade" id="delete" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body m-3">
                <form class="form-horizontal" method="POST" action="account-delete.php">
                    <input type="hidden" class="acc_id" name="id">
