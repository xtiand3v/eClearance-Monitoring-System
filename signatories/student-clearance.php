                                    ...
                                    <table class="table table-hover my-0" id="department">
                                        ...
                                        <tbody>
                                            ...
                                            while ($row = mysqli_fetch_assoc($result)) {
                                                ...
                                                if($status == "0"){
                                                        ?>
                                                        <a href="clear-clearance.php?id=<?php echo $id ?>&dept=<?php echo $dept_id ?>&sec=<?php echo $section_id; ?>&cle=<?php echo $get_row['clearance_id']; ?>" class="btn btn-success btn-sm">Clear</a>
